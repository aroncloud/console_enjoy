...
<template>
  <Transition name="modal">
    ...
    >
      ...
      <!-- Card -->
      <div class="relative w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl shadow-2xl overflow-hidden modal-card">
        ...
        <div class="p-4 sm:p-6">
          ...
          <div class="flex items-start gap-4 mb-5">
            <div class="shrink-0 w-12 h-12 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-900/30 flex items-center justify-center">
          ...
          <!-- Message -->
          <div class="rounded-xl bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/30 px-4 py-3 mb-5">
